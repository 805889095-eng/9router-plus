...
> 🎬 **¿Has hecho un video sobre 9Router?** Envía una [Pull Request](https://github.com/805889095-eng/9router-plus/pulls) añadiendo tu video a esta sección — ¡lo fusionaremos!
...
docker pull 805889095-eng/9router-plus:latest   # actualiza a la última versión
```
...
- **Problemas**: [github.com/805889095-eng/9router-plus/issues](https://github.com/805889095-eng/9router-plus/issues)
