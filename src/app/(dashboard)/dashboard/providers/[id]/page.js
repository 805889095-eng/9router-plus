  ...
  const handleImportQoderModels = async () => {
    ...
    try {
      ...
      for (const model of models) {
        ...
        // Qoder model ID format may be "qoder/auto", "qoder-cn/auto", or "auto", need to remove prefix
        const cleanModelId = modelId.replace(/^(?:qoder|qoder-cn)\//, "");
  ...
  const renderModelsSection = () => {
    ...
    return (
      <div className="flex flex-wrap gap-3">
        ...
        {/* Import Qoder models button — show for qoder and qoder-cn provider */}
