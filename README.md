<div align="center">
  ...
  # 9Router Plus - FREE AI Router & Token Saver
  ...
  **Connect All AI Code Tools (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) to 40+ AI Providers & 100+ Models.**
  ...
  [![Docker Pulls](https://img.shields.io/docker/pulls/805889095-eng/9router-plus.svg?logo=docker&label=Docker%20pulls)](https://hub.docker.com/r/805889095-eng/9router-plus)
  [![GHCR](https://img.shields.io/badge/GHCR-805889095-eng%2F9router-plus-blue?logo=github)](https://github.com/805889095-eng/9router-plus/pkgs/container/9router)
  [![License](https://img.shields.io/npm/l/9router.svg)](https://github.com/805889095-eng/9router-plus/blob/main/LICENSE)

<a href="https://trendshift.io/repositories/22628" target="_blank"><img src="https://trendshift.io/api/badge/repositories/22628" alt="805889095-eng%2F9router-plus | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>

[🚀 Quick Start](#-quick-start) • [💡 Features](#-key-features) • [📖 Setup](#-setup-guide) • [🌐 Website](https://9router-plus.com)
...
> 🎬 **Made a video about 9Router?** Submit a [Pull Request](https://github.com/805889095-eng/9router-plus/pulls) adding your video to this section — we'll merge it!
...
export NEXT_PUBLIC_CLOUD_URL="https://9router-plus.com"
...
- Docker Hub: [`805889095-eng/9router-plus`](https://hub.docker.com/r/805889095-eng/9router-plus)
- GHCR: [`ghcr.io/805889095-eng/9router-plus`](https://github.com/805889095-eng/9router-plus/pkgs/container/9router)
...
docker run -d \
  ...
  -e DATA_DIR=/app/data \
  805889095-eng/9router-plus:latest
```
...
docker pull 805889095-eng/9router-plus:latest   # update to latest
```
...
| `CLOUD_URL`                                          | `https://9router-plus.com`                    | Server-side cloud sync endpoint base URL                                            |
| `NEXT_PUBLIC_BASE_URL`                               | `http://localhost:3000`                  | Backward-compatible/public base URL (prefer `BASE_URL` for server runtime)          |
| `NEXT_PUBLIC_CLOUD_URL`                              | `https://9router-plus.com`                    | Backward-compatible/public cloud URL (prefer `CLOUD_URL` for server runtime)        |
...
- **Website**: [9router-plus.com](https://9router-plus.com)
- **GitHub**: [github.com/805889095-eng/9router-plus](https://github.com/805889095-eng/9router-plus)
- **Issues**: [github.com/805889095-eng/9router-plus/issues](https://github.com/805889095-eng/9router-plus/issues)
...
[![Contributors](https://contrib.rocks/image?repo=805889095-eng/9router-plus&max=150&columns=15&anon=1&v=20260309)](https://github.com/805889095-eng/9router-plus/graphs/contributors)
